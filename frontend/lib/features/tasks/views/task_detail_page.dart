  ...
  void _showReopenDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Row(
          children: [
            Icon(Icons.refresh, color: Colors.orange.shade700, size: 22),
            const SizedBox(width: 8),
            const Text('Reopen Task'),
          ],
        ),
        content: Form(
          key: formKey,
          child: Column(
            ...
            children: [
              Text(
                'This will set the task back to "In Progress". A comment explaining the reason is required.',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g. Requirements changed, incomplete work...',
                  border: OutlineInputBorder(),
                ),
                validator: (v) =>
