...
class ApiConstants {
  ...
  /// Socket.io server URL derived from API base URL.
  ...
  static String taskReopen(int id) => '/tasks/$id/reopen';
  ...
  static const String notificationDeleteRead = '/notifications/delete-read';
  static const String notificationPreferences = '/notifications/preferences';

  // Approvals
  static const String approvals = '/approvals';
  static String approvalSubmit(int id) => '/approvals/$id/submit-for-approval';
  static const String approvalPending = '/approvals/manager/pending-approvals';
  static const String approvalPendingCount = '/approvals/manager/pending-approvals-count';
  static String approvalApprove(int id) => '/approvals/$id/approve';
  static String approvalReject(int id) => '/approvals/$id/reject';
  static String approvalHistory(int id) => '/approvals/$id/approval-history';
