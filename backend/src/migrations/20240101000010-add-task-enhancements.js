...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    // 1. Add show_collaborators to tasks
    ...
    // 2. Add escalation_level to tasks (0=none, 1=dept_head notified, 2=mgmt notified, 3=critical)
    ...
    // 3. Add last_escalation_at to tasks
    ...
    // 4. Create task_assignments table (multi-user per task)
